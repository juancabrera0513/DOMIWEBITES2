...
// Si quieres el review snippet aquí también, puedes copiar el array de reviews
const reviews = [
  {
    name: "Melii Soler",
    rating: 5,
    ...
    <section className="py-24 bg-white min-h-screen" aria-labelledby="blog-heading">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-10">
          {blogPosts.map((post) => (
            <article key={post.slug} className="bg-gray-50 p-6 rounded-lg shadow hover:shadow-lg transition">
              {post.image && (
                <img
                  src={post.image}
                  alt={post.title}
