          ...
          {webPackages.map((pkg, idx) => (
            ...
            >
              ...
              <button
                ...
                className="mt-2 px-5 py-2.5 bg-gradient-to-r from-red-700 to-blue-700 text-white rounded-full shadow-md hover:scale-110 transition duration-300 ease-in-out text-center font-medium"
